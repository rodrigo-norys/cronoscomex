...
**94 das 96 histórias estão concluídas**, e o épico aberto é `E15`. O que cada uma aprendeu — número medido,
...
processos ativos — 48 de 48 — passaram a "Sem responsável". **`H-94` fechou no
mesmo dia**, com a cor de cada célula como fundo da tabela. Resta `H-95`, que
completa o espelho: as 16 colunas
