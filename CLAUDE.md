...
**75 das 76 histórias concluídas.** O que cada uma aprendeu — número medido,
...
- **`E12` — Os achados da revisão de estilo.** `H-73` ✅ a `H-75` ✅; resta
  `H-76`, e ela não está bloqueada. Nasce de `docs/redesign/REVISAO-ESTILO.md`, a
