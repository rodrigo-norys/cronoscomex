  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="rounded-control bg-action-bg px-3 py-1.5 text-sm font-medium text-action-fg hover:bg-action-bg-hover disabled:cursor-not-allowed disabled:bg-control-disabled-bg disabled:text-control-disabled-fg"
      >
        {busy
          ? 'Aplicando…'
          : pendingCount === 0
