...
**88 das 91 histórias** de [`docs/06-backlog.md`](docs/06-backlog.md) estão
...
abertas são do épico `E14`: o mapa de clientes e o de equipe operáveis pela
tela, e a ordem em que a planilha está.
