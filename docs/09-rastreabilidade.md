...
| H-36 | Cadeia base | ⬜ **Aberta.** O checklist das etapas de partida no painel, o botão de revalidação sem reexecutar o atalho, e o `config/app.json.exemplo` fiel à forma que a aplicação grava. Nasceu do corte de `H-35`, que chegaria a nove arquivos |
