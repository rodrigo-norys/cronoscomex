...
| H-53 | IND-22, §3.1 (Página Performance) | ✅ **Concluída, com o quinto critério não-incidente.** A página passa a dizer o que mede — `RG − DOCS ENVIADOS` em dias inteiros, na ordem que A-02 fixou — e **sobre o que** mede: o painel de recorte nomeia cada filtro ativo, ou declara que os números cobrem a base inteira e aponta a barra. As duas exclusões de A-30 ganham o que significam, e a amostra zerada diz por que exibe traço. **Nenhum dos dois defeitos era de cálculo** — a métrica está certa desde IND-22 e o filtro funciona desde `H-15` —, e é isso que os tornava fáceis de deixar abertos para sempre. **O quinto critério é `H-66`**, que saiu do corte de `H-50` em 31/08/2026 (`D-24`) e carrega exatamente esta linha: a ressalva de A-31 segue descrevendo a limitação que ainda existe, e reescrevê-la antes do campo novo afirmaria que ela acabou |
