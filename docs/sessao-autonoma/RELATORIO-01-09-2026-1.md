...
| O que | Motivo |
|---|---|
| **Onda 2 — `H-50` e `H-66`** | **Limite de PRs do mandato.** Ele manda parar em 6 PRs abertos, e a Onda 1 os consumiu exatamente. `H-50` é a única `G` do backlog — 12 arquivos e três contratos — e não caberia como sétimo. Ela segue **pronta para `/abrir-historia`**: `D-23` e `D-24` já decidiram o que a travava |
