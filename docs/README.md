...
| 7 | [06-backlog.md](06-backlog.md) | **91 histórias executáveis** em 14 épicos (`E1` a `E14`), com contrato, aceite e casos-limite — 88 concluídas, **as 3 de `E14` abertas** | — |
...
**88 das 91 histórias estão concluídas.** `E9`, `E10`, `E11` e `E12` fecharam em
...
08/09/2026**. **Restam três:** o mapa de clientes e o de equipe operáveis pela
tela (`D-32` e `D-35`, duas histórias numa branch de integração) e a ordem em que a
