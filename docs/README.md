...
| 7 | [06-backlog.md](06-backlog.md) | **96 histórias executáveis** em 15 épicos (`E1` a `E15`), com contrato, aceite e casos-limite — 94 concluídas, **as 2 restantes de `E15` abertas** | — |
...
**94 das 96 histórias estão concluídas.** `E9`, `E10`, `E11` e `E12` fecharam em
...
**`H-91` fechou o épico em 16/09/2026**: o mapa de equipe operável pela tela, que sai de `PD-08`. **`E15` abriu com quatro** — `H-93` a `H-96`, de `D-40` a `D-43` —, e nelas a cor deixa de ser dado e a tabela passa a espelhar a planilha. **`H-93` e `H-94` fecharam em 16/09/2026** — a cor saiu da regra de responsável e passou a pintar cada célula da tabela. Três dos quatro épicos posteriores ao
